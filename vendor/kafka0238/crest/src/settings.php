<?php
define('C_REST_CLIENT_ID','local.64b8e364477e29.02338610');//Application ID
define('C_REST_CLIENT_SECRET','0B0JdjITV1kvYIs3YLbkWvAQCfVh761VQOO6I3F6So9bKP6Ip2');//Application key
// or// or
